...
public class MainActivity extends FragmentActivity implements
	...
	protected DialogInterface.OnClickListener mDialogListener = new DialogInterface.OnClickListener() {
		...
		private void pickPhotoOrVideoIntent(String type) {
			Intent pickIntent = new Intent(Intent.ACTION_GET_CONTENT);
			pickIntent.setType(type);
			startActivityForResult(pickIntent, PICK_VIDEO_PHOTO_REQUEST);
		}
	...
	protected void onActivityResult(int requestCode, int resultCode, Intent data) {
		...
		if (resultCode == RESULT_OK) {
			if(requestCode == PICK_VIDEO_PHOTO_REQUEST){
				if(data == null){
				...
				if(video_request_flag == true){
					...
					try{
						...
						Toast.makeText(this, R.string.error_openeing_file, Toast.LENGTH_LONG).show();
						return;
					}
					catch (IOException e){
						Toast.makeText(this, R.string.error_openeing_file, Toast.LENGTH_LONG).show();
